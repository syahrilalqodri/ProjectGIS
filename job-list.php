				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="job-list.php">Intership List</a>
							...
							<li>
								<a href="employees.php">Candidate</a>
							</li>
				...
				<div class="container">
					...
					<form action="job-list.php" method="GET" autocomplete="off">
						...
						<div class="second-search-result-inner">
							<span class="labeling">Find Intership</span>
							<div class="row">
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
								...
								if ($type == "WFH") {
								$sta = '<span class="job-label label label-success">WFH</span>';
											  
								}
								if ($type == "WFO") {
								$sta = '<span class="job-label label label-danger">WFO</span>';
											  
								}
								if ($type == "WFH-WFO") {
								$sta = '<span class="job-label label label-warning">WFH-WFO</span>';
										...
										<div class="content">
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">View This Intership</a>
													</div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Fintern</h5>
											<p>Fintern is an application that provides information about internships for students and the general public.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="./">Home</a></li>
											<li><a href="job-list.php">Intership List</a></li>
											<li><a href="employers.php">Company</a></li>
											<li><a href="employees.php">Candidate</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Fintern Contact</h5>
								
								<p>Address : Malang, Jawa Timur</p>
								<p>Email : <a href="mailto:fintern@gmail.com">fintern@gmail.com</a></p>
								<p>Phone : <a href="tel:+6282332258553">+6282332258553</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Fintern Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Fintern Group</a></li>
								</ul>
