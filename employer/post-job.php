										...
										<form class="post-form-wrapper" action="app/post-job.php" method="POST" autocomplete="off">
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label>Region</label>
														<input name="city" required type="text" class="form-control" placeholder="Enter Region">
													</div>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option value="WFH" data-content="<span class='label label-warning'>WFH</span>">WFH</option>
															<option value="WFO" data-content="<span class='label label-danger'>WFO</span>">WFO</option>
															<option value="WFH-WFO" data-content="<span class='label label-success'>WFH-WFO</span>">Mix WFH-WFO</option>
														</select>
													</div>
